...
public abstract class AbstractQuery {
	...
	/**
	 * @return Values of the query parameters (denoted by '?' in the SQL query).
	 */
	 ...
	 * Creates a prepared statement and sets the parameter values.
	 * @param con Connection to the database.
	 * @param autoGeneratedKeys A value to be passed to autoGeneratedKeys parameter of prepareStatement.
	 * @return Prepared statement. Must be closed by the caller.
	 * @throws SQLException On SQL error.
	 */
	...
	/**
	 * Obtains a connection from the source, performs a query,
	 * calls {@link ResultSetWrapper#map(ResultSetMapper)} with the specified mapper and returns the result.
	 * @param source Data source.
	 * @param mapper Mapper.
	 * @param <T> Result type.
	 * @return Result.
	...
	/**
	 * Obtains a connection from the source, performs a query,
	 * calls {@link ResultSetWrapper#mapAll(ResultSetMapper)} with the specified mapper and returns the result.
	 * @param source Data source.
	 * @param mapper Mapper.
	 * @param <T> Result type.
	 * @return Result.
